...
class FormA(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        super().__init__()
        self.btnPress = QtWidgets.QPushButton("Table AAAA")
...
class FormB(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        super().__init__()
        self.btnPress = QtWidgets.QPushButton("Table BBBBBBBBBBBB")
        layout = QtWidgets.QVBoxLayout()
        self.setLayout(layout)
        layout.addWidget(self.btnPress)
        self.setStyleSheet("background-color:green;")
...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.right_bar_layout.setAlignment(QtCore.Qt.AlignLeft) # 布局内的部件左对齐
        self.right_bar_layout.setSpacing(0) # 设置布局内部件间隙为0    设置内边框距离
        ...
        self.right_newsong_layout.setContentsMargins(0,0,0,0)
        self.right_newsong_layout.setSpacing(0)
        ...
        self.right_newsong_layout.setAlignment(QtCore.Qt.AlignTop)  # 布局内的部件左对齐
        ...
        # print(self.main_layout.rowCount())        # 获取总行数
        # print(self.main_layout.columnCount())     # 获取总列数
        ...
        print(self.right_widget.width(), self.right_widget.height(), '-----22-----------')


        self.left_button_1.pressed.connect(self.check)


    def ali_platform(self):
        pass
    ...
    def check(self):
        print("按钮被点击啦")
        # 1. 获取文本框内容
        content = self.left_button_1.text()
        print(content, '========================')
        self.right_widget.hide()
        self.self.stacked_layout.show()
